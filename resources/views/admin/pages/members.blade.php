                ...
                <div class="col-sm-4">
                    <a href="#custom-modal" class="btn btn-primary waves-effect waves-light mb-3" data-animation="fadein"
                        data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a"><i
                            class="md md-add"></i> Add Member</a>
                </div><!-- end col -->
                <div class="col-sm-8">
            ...
            <div class="row">
                    ...
                    <div class="text-center card-box">
                        ...
                        <div class="member-card">
                            <div class="avatar-xl member-thumb mx-auto">
                                <img src="{{asset('assets/admin/images/users/avatar-3.jpg')}}" class="rounded-circle img-thumbnail"
                                    alt="profile-image">
                    ...
                    <div class="text-center card-box">
                        ...
                        <div class="member-card">
                            <div class="avatar-xl member-thumb mb-2 mx-auto">
                                <img src="{{asset('assets/admin/images/users/avatar-5.jpg')}}" class="rounded-circle img-thumbnail"
                                    alt="profile-image">
                                <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        ...
                        <div class="member-card">
                            <div class="avatar-xl member-thumb mb-2 mx-auto">
                                <img src="{{asset('assets/admin/images/users/avatar-2.jpg')}}" class="rounded-circle img-thumbnail"
                                    alt="profile-image">
                                <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        ...
                        <div class="member-card">
                            <div class="avatar-xl member-thumb mb-2 mx-auto">
                                <img src="{{asset('assets/admin/images/users/avatar-4.jpg')}}" class="rounded-circle img-thumbnail"
                                    alt="profile-image">
                                <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        ...
                        <div class="member-card">
                            <div class="avatar-xl member-thumb mb-2 mx-auto">
                                <img src="{{asset('assets/admin/images/users/avatar-6.jpg')}}" class="rounded-circle img-thumbnail"
                                    alt="profile-image">
                                <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        ...
                        <div class="member-card">
                            <div class="avatar-xl member-thumb mb-2 mx-auto">
                                <img src="{{asset('assets/admin/images/users/avatar-7.jpg')}}" class="rounded-circle img-thumbnail"
                                    alt="profile-image">
                                <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        ...
                        <div class="member-card">
                            <div class="avatar-xl member-thumb mb-2 mx-auto">
                                <img src="{{asset('assets/admin/images/users/avatar-8.jpg')}}" class="rounded-circle img-thumbnail"
                                    alt="profile-image">
                                <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        ...
                        <div class="member-card">
                            <div class="avatar-xl member-thumb mb-2 mx-auto">
                                <img src="{{asset('assets/admin/images/users/avatar-9.jpg')}}" class="rounded-circle img-thumbnail"
                                    alt="profile-image">
                                <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        ...
                        <div class="member-card">
                            <div class="avatar-xl member-thumb mb-2 mx-auto">
                                <img src="{{asset('assets/admin/images/users/avatar-10.jpg')}}" class="rounded-circle img-thumbnail"
                                    alt="profile-image">
                                <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                            </div>
