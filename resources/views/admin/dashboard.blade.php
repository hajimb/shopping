        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-xl-4 col-sm-6">
                        <div class="card-box widget-box-four">
                            ...
                            <div class="float-left">
                                <h4 class="mt-0 font-15 font-weight-medium mb-1 text-overflow"
                                    title="Total Revenue">Total Revenue</h4>
                                <p class="font-secondary text-muted">Jan - Apr 2019</p>
                                <h3 class="mb-0 mt-2"><span>$</span> <span
                                        data-plugin="counterup">5,2548</span></h3>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="card-box widget-box-four">
                            ...
                            <div class="float-left">
                                <h4 class="mt-0 font-15 mb-1 font-weight-medium text-overflow"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="mt-3 mb-3">
                                            ...
                                            <p class="text-uppercase mb-1 font-13 font-weight-normal">
                                                Lifetime total sales</p>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="mt-3 mb-3">
                                    ...
                                    <div class="col-4">
                                        <div class="mt-3 mb-3">
                                            ...
                                            <p class="text-uppercase mb-1 font-13 font-weight-normal">Total
                                                visits</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="morris-bar-stacked" style="height: 310px;" class="morris-charts">
                            </div>
            ...
            <div class="col-xl-4">
                ...
                <div class="card-box">
                    ...
                    <div class="mb-1">
                        <p><span class="float-right text-dark">Mark Loyerdn</span> <span
                                class="badge badge-primary">Visitor</span></p>
                        <p class="mb-1">Praesent libero. Nunc nec dui vitae urna cursus lacinia. In
                            venenatis eget justo in dictum. Vestibulum auctor raesent quisnm.</p>
                        <p><i>2 Min ago</i></p>
                    </div>

                    <div class="">
                        <p><span class="float-right text-dark">Mark Loyerdn</span> <span
                                class="badge badge-success">Seller</span></p>
                        <p class="mb-1">Praesent libero. Nunc nec dui vitae urna cursus lacinia. In
                            venenatis eget justo in dictum. Vestibulum auctor raesent quisnm.</p>
