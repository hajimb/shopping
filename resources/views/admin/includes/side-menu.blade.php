        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li><a href="{{route('admin.pages.starter')}}">Starter Page</a></li>
                        <li><a href="{{route('admin.login')}}">Login</a></li>
                        <li><a href="{{route('admin.register')}}">Register</a></li>
                        <li><a href="{{route('admin.logout')}}">Logout</a></li>
                        <li><a href="{{route('admin.password.reset')}}">Recover Password</a></li>
                        <li><a href="{{route('admin.lock')}}">Lock Screen</a></li>
                        <li><a href="{{route('admin.404')}}">Error 404</a></li>
                        <li><a href="{{route('admin.500')}}">Error 500</a></li>
                        <li><a href="{{route('admin.company')}}">Company</a></li>
                        <li><a href="{{route('admin.members')}}">Members</a></li>
                        <li><a href="{{route('admin.maintainance')}}">Maintainance</a></li>
                    </ul>
                </li>
