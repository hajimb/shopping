                ...
                <div class="col-sm-12 col-xs-12 col-lg-8">
                    ...
                    <div class="footer-column pull-left">
                        ...
                        <ul class="links">
                            ...
                            <li class=" last"><a href="#" title="Our stores" class="link-rss">Our stores</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-xs-12 col-lg-4">
                    <div class="footer-column-last">
                        ...
                        <div class="payment-accept">
                            <div><img src="{{asset('assets/frontend')}}/images/payment-1.png" alt="payment1"> <img src="{{asset('assets/frontend')}}/images/payment-1.png"
                                    alt="payment2"> <img src="{{asset('assets/frontend')}}/images/payment-1.png" alt="payment3"> <img
                                    src="{{asset('assets/frontend')}}/images/payment-1.png" alt="payment4"> </div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <address>
                    <i class="fa fa-map-marker"></i> 123 Main Street, Anytown, CA 12345 USA <i
                        class="fa fa-mobile"></i><span> +(408) 394-7557</span> <i class="fa fa-envelope"></i><span>
                        abc@magikcommerce.com</span>
                </address>
            </div>
        </div>
    </div>
