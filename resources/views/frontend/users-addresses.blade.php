    ...
    <div class="main container">
      <div class="col-main">
        ...
        <div class="state_bar">
          ...
          <form method="post" action="addressesPost/" id="checkout_multishipping_form">
            ...
            <div class="addresses">
              <div class="table-responsive">
                <fieldset class="multiple-checkout">
                    ...
                    <tbody>
                      <tr class="first odd">
                        ...
                        <td><select title="" class="" id="ship_0_43_address" name="ship[0][43][address]">
                            <option selected="selected" value="1">John Doe, aundh, tyyrt, Alabama 46532, United States</option>
                          </select></td>
                  ...
                  <div class="buttons-set"> <a href="{{route('shopping.cart')}}" class="back-link"><small>« </small>Back to Shopping Cart</a>
