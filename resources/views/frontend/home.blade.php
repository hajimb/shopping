                ...
                <div class="col-md-9">
                    <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container'>
                        <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                            <ul>
                                <li data-transition='random' data-slotamount='7' data-mIberisspeed='1000'
                                    data-thumb='http://via.placeholder.com/915x490'><img
                                        src='http://via.placeholder.com/915x490' alt="slide-img" data-bgposition='left top'
                                    ...
                                    <div class="info">
                                        <div class='tp-caption ExtraLargeTitle sft  tp-resizeme ' data-endspeed='500'
                                            ...
                                            data-endelementdelay='0.1' style='z-index:2;white-space:nowrap;'><span>Stylish
                                                Women</span> </div>
                                        <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-endspeed='500'
                                            ...
                                            data-splitin='none' data-splitout='none' data-elementdelay='0.1'
                                            data-endelementdelay='0.1' style='z-index:3;white-space:nowrap;'><span>Perfect
                                                Jewellery</span> </div>
                                        ...
                                        <div class='tp-caption sfb  tp-resizeme ' data-endspeed='500' data-speed='500'
                                            ...
                                            data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:4;white-space:nowrap;'><a href='#' class="buy-btn">Shopping
                                                Now</a> </div>
                                    </div>
                                </li>
                                <li data-transition='random' data-slotamount='7' data-mIberisspeed='1000'
                                    ...
                                    <div class="info">
                                        <div class='tp-caption ExtraLargeTitle sft slide2  tp-resizeme ' data-endspeed='500'
                                            ...
                                            style='z-index:2;white-space:nowrap;padding-right:0px'><span>Special
                                                Offer</span> </div>
                                        <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-endspeed='500'
                                            data-speed='500' data-start='1300' data-easing='Linear.easeNone'
                                            data-splitin='none' data-splitout='none' data-elementdelay='0.1'
                                            data-endelementdelay='0.1' style='z-index:3;white-space:nowrap;'>accessories
                                        </div>
                                        <div class='tp-caption Title sft  tp-resizeme ' data-endspeed='500' data-speed='500'
                                            data-start='1500' data-easing='Power2.easeInOut' data-splitin='none'
                                            data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:4;white-space:nowrap;'>Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit.</div>
                                        <div class='tp-caption sfb  tp-resizeme ' data-endspeed='500' data-speed='500'
                                            data-start='1500' data-easing='Linear.easeNone' data-splitin='none'
                                            data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1'
                                    ...
                                    <div class="item-img-info"> <a href="#" title="Retis lapen casen"
                                        ...
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a class="link-quickview" href="{{route('quick.view')}}">Quick View</a> </li>
                                ...
                                <div class="item-info">
                                    <div class="info-inner">
                                        <div class="item-title">
                                            <h4><a href="{{route('product.details')}}" title="Retis lapen casen"> Retis lapen casen
                                                </a></h4>
                                        </div>
                ...
                <div class="navbar nav-menu">
                    <div class="navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li>
                                <div class="new_title">
                                    <h1><strong>new</strong> Products</h1>
                                </div>
                            </li>
                                                ...
                                                <div class="item-inner">
                                                    <div class="item-img">
                                                        <div class="item-img-info"> <a class="product-image"
                                                                title="Retis lapen casen" href="{{route('product.details')}}"> <img
                                                                    alt="Retis lapen casen"
                                                                    src="http://via.placeholder.com/700x850"> </a>
                                                            <div class="box-hover">
                                                                <ul class="add-to-links">
                                                                    <li><a class="link-quickview"
                                                                            href="{{route('quick.view')}}">Quick View</a> </li>
                                                                    <li><a class="link-wishlist"
                                                                            href="{{route('users.whishlist')}}">Wishlist</a> </li>
                                                    ...
                                                    <div class="item-info">
                                                        <div class="info-inner">
                                                            <div class="item-title">
                                                                <h4><a title="Retis lapen casen"
                                                                        href="{{route('product.details')}}"> Retis lapen casen </a>
                                                                </h4>
                                                            </div>
                                                            <div class="item-content">
                                                                <div class="rating">
                ...
                <div class="bestsell-block">
                    <div id="bestsell-slider" class="product-flexslider hidden-buttons">
                        <div class="home-block-inner">
                            ...
                            <div class="pretext">Lorem Ipsum is simply dummy text of the printing and typesetting
                                ...
                                <div class="item-inner">
                                    <div class="item-img">
                                        <div class="item-img-info"> <a class="product-image" title="Retis lapen casen"
                                                href="{{route('product.details')}}"> <img alt="Retis lapen casen"
                                                    src="http://via.placeholder.com/700x850"> </a>
                                    ...
                                    <div class="item-info">
                                        <div class="info-inner">
                                            <div class="item-title">
                                                <h4><a title="Retis lapen casen" href="{{route('product.details')}}"> Retis lapen
                                                        casen </a></h4>
                                            </div>
                                            <div class="rating">
                                                <div class="ratings">
                                    ...
                                    <div class="item-info">
                                        <div class="info-inner">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <div class="item-price">
                                                    <div class="price-box"> <span class="regular-price"> <span
                                                                class="price">$425.00</span> </span> </div>
                                                </div>
                                                <div class="action">
                                                    <button class="button btn-cart" type="button" title=""
                                                        data-original-title="Add to Cart"><span>Add to Cart</span>
                                    ...
                                    <div class="item-info">
                                        <div class="info-inner">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <div class="item-price">
                                                    <div class="price-box"> <span class="regular-price"> <span
                                                                class="price">$525.00</span> </span> </div>
                                                </div>
                                                <div class="action">
                                                    <button class="button btn-cart" type="button" title=""
                                                        data-original-title="Add to Cart"><span>Add to Cart</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="bottom-banner-img1"> <a href="#"> <img src="http://via.placeholder.com/390x240"
                                alt="bottom banner">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="bottom-banner-img1"> <a href="#"> <img src="http://via.placeholder.com/390x240"
                                alt="bottom banner"><span class="banner-overly"></span>
                            <div class="bottom-img-info1">
                                <h3>Men Shoes</h3>
                                <span class="line"></span>
                            </div>
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="bottom-banner-img1 last"> <a href="#"><img
                                src="http://via.placeholder.com/810x240" alt="bottom banner"> <span
                ...
                <div class="blog-outer-container">
                    ...
                    <div class="blog-inner">
                        <div class="col-lg-6 col-md-6 col-sm-6 blog-preview_item">
                            <div class="entry-thumb image-hover2"> <a href="{{route('blog.single')}}"> <img
                                        alt="Blog" src="http://via.placeholder.com/1140x450"> </a> </div>
                            <div class="blog-preview_info">
                                ...
                                <h4 class="blog-preview_title"><a href="{{route('blog.single')}}">Standard blog post with
                                        photo</a></h4>
                                <div class="blog-preview_desc">Lid est laborum dolo rumes fugats untras. Etharums ser
                                    quidem rerum facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips.
                                </div>
                                <a class="blog-preview_btn" href="{{route('blog.single')}}">READ MORE</a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 blog-preview_item">
                            <div class="entry-thumb image-hover2"> <a href="{{route('blog.single')}}"> <img
                            ...
                            <div class="blog-preview_info">
                                ...
                                <div class="blog-preview_desc">Ut tellus dolor, dapibus eget, elementum vel, cursus
                                    eleifend, elit. Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Donec
                                    sit amet eros.</div>
                                <a class="blog-preview_btn" href="{{route('blog.single')}}">READ MORE</a>
                            </div>
                        </div>
