...
function revslider_showDoubleJqueryError(e) {
    ...
    function L(n, r) {
        ...
        if (u.data("differentissplayed") == "prepared") {
            ...
            u.data("mIberisspeed", u.data("savedmIberisspeed"))
        }
        if (u.data("fstransition") != t && u.data("differentissplayed") != "done") {
            u.data("savedtransition", u.data("transition"));
            u.data("savedslotamount", u.data("slotamount"));
            u.data("savedmIberisspeed", u.data("mIberisspeed"));
            u.data("transition", u.data("fstransition"));
            u.data("slotamount", u.data("fsslotamount"));
            u.data("mIberisspeed", u.data("fsmIberisspeed"));
        ...
        if (l < 0) l = 0;
        var N = 300;
        if (u.data("mIberisspeed") != t && u.data("mIberisspeed") > 99 && u.data("mIberisspeed") < 4001) N = u.data("mIberisspeed");
        S = v[y];
